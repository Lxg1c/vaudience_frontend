...
import { registerUser, loginUser } from "../../enteties/user/index.js";
                ...
                <div className="auth-tabs">
                    {["login", "registration"].map((type) => (
                        ...
                        >
                            ...
                            {authType === type && <motion.div className="underline" layoutId="underline" transition={{ duration: 0.3 }} />}
                        </motion.button>
                    ))}
                </div>
                        ...
                        <form onSubmit={handleSubmit} className="auth-form">
                            ...
                            {authType === "login" && (
                                <div className="forgot__password-container">
                                    <a className="forgot__password-container--link btn-reset" href="#">Забыли пароль?</a>
                                </div>
                            )}
                        </form>
                    </motion.div>
