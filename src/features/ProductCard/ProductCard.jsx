...
const ProductCard = () => {
  ...
  const toggleFavorite = () => {
    ...
    if (isFavorite) {
      ...
      showNotification("success", "Удалено из избранного", `${data.title} больше не в избранном`);
    } else {
      if (!selectedSize) {
        showNotification("warning", "Выберите размер", "Пожалуйста, укажите размер товара");
        return;
      ...
      showNotification("success", "Добавлено в избранное", `${data.title} теперь в избранном`);
    }
  };
